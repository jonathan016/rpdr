...
class MDRY2Runner:
    ...
    def pre_init(model_kwargs, learning_rate, batch_size, decay, momentum):
        ...
        model: MDRY2 = MDRY2(**model_kwargs)
    ...
    def __init__(self, model: MDRY2, optimizer, dataset, validation_dataset, batch_size=64, iterations: tuple = None,
