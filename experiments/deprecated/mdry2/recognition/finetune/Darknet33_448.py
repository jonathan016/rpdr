...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', default='./rpdr-config-results/results/mdry2/3_448.log', help='Where to save logs')
    parser.add_argument('-w', default='./rpdr-config-results/results/mdry2/3_448.pth.tar',
                        help='Epoch checkpoint output path')
    parser.add_argument('-b', default='./rpdr-config-results/results/mdry2/3_448_best_model.pth.tar',
                        help='Weight output path')
    parser.add_argument('-bb', default='./rpdr-config-results/results/mdry2/16_224_best_model.pth.tar',
    ...
    darknet33.load_state_dict(torch.load(backbone)['state_dict'])
    sgd = SGD(darknet33.parameters(), lr=.005, momentum=.9, weight_decay=.0005)
    ...
    for epoch in range(start_epoch, end_epoch):
        darknet33, sgd, crit = train(darknet33, sgd, crit, epoch, train_loader, val_loader, save, best)
    end_time = time.time()
