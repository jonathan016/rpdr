...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', default='./rpdr-config-results/results/yolo/v2/6.log', help='Where to save logs')
    parser.add_argument('-w', default='./rpdr-config-results/results/yolo/v2/6_224.pth.tar',
                        help='Epoch checkpoint output path')
    parser.add_argument('-b', default='./rpdr-config-results/results/yolo/v2/6_224_best_model.pth.tar',
