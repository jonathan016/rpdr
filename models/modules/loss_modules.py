from torch import Tensor, cuda, linspace, LongTensor, FloatTensor, device as torch_device, exp as torch_exp, \
    ones as torch_ones, zeros as torch_zeros, max as torch_max, reshape as torch_reshape, float as torch_float, \
    long as torch_long, cat as torch_cat, log as torch_log
from torch.nn import Module, MSELoss, CrossEntropyLoss, BCELoss, L1Loss
