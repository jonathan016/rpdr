...
def augment(img, shape, jitter, hue, saturation, exposure, do_flip):
    oh = img.height
    ow = img.width
...
def augment_data(image, max_object, yolo_labels, shape, jitter, hue, saturation, exposure, do_flip=True):
    image, flip, dx, dy, sx, sy = augment(image, shape, jitter, hue, saturation, exposure, do_flip)
